...
| RF-20 auditoría histórica                               | Ausente                      | Hay timestamps y soft delete en algunas entidades, pero no trazas de actor, acción, recurso, valores anterior/nuevo ni consulta restringida.                                                                                              | Danny |
| RF-22 Facebook: seis recientes, histórico y BD | Parcial                      | Existe endpoint y caché RSS/fallback; no usa verificablemente Meta Graph API, no persiste publicaciones ni mueve las seis iniciales al home mientras conserva histórico. El controller documenta 3 por defecto aunque el frontend pide 6. | sebas               |
