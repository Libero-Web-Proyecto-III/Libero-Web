...
export interface AuthResponse {
  ...
  data: {
    accessToken: string;
    user: { id: number; uuid?: string; username: string; email: string; role: string; avatar?: string };
  };
}
...
export class AuthService {
  ...
  // # Este bloque tiene como objetivo retornar de forma segura los datos del usuario logueado
  getUser(): { id: number; username: string; email: string; role: string; avatar?: string } | null {
    const user = this.currentUser();
